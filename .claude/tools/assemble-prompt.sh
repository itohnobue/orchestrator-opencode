...
#
# Usage:
#   .claude/tools/assemble-prompt.sh -a AGENT -t TYPE -n NAME --task TASK_FILE [-o OUT]
#
# Arguments:
#   -a, --agent       Agent name — reads .claude/agents/{agent}.md
...
#
# Example:
#   .claude/tools/assemble-prompt.sh \

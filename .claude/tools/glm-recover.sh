...
echo ""
echo "=== MEMORY SESSION ==="
MEMORY_SH=".claude/tools/memory.sh"
if [[ -x "$MEMORY_SH" ]]; then
...
echo ""
echo "Next steps (CLAUDE.md compaction recovery protocol):"
echo "  1. Re-read CLAUDE.md in full — MANDATORY, no partial reads"

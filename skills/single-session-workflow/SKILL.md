...
| `adversarial-reviewer` | Falsification gate (always MAX reasoning effort) — part of the optional VERIFY block. The single distinct quality gate: batch sizes CRITICAL (1:1), HIGH (1:3), MEDIUM (1:10) are volume controls, not effort tiers. Process-only, independent of research data. |

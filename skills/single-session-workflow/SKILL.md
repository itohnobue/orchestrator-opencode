...
| `postfix-reviewer` | Post-fix review ONLY (always MAX reasoning effort, strictly read-only) — verifies applied fixes against their design: correctness, minimality, new bugs, test breakage, race conditions; verdict APPROVED / NEEDS-FIX. Never used for any other task. No research of its own. |

...
- Re-verify: re-run the adversarial check on the changed parts; any new CONFIRMED findings go back to the fix stage. Cap: 3 fix passes per task — persistent issues are reported to the user, not looped forever

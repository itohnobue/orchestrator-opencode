...
- Stage 2 (Adversarial): Minimum 1 extraction + 1 adversarial falsification agent. Scale up with finding volume — each batch of 5-8 findings = 1 additional falsification agent.
